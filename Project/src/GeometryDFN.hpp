...
struct Struttura_DFN{
    ...
    map <unsigned int, vector<Vector3d>> coordinateVertici = {}; /// chiave Id_fratture, dimensione (3 x numVertici) x numFratture
    ...
    map <unsigned int, array<Vector3d, 2>> coordinateTraccia = {}; /// chiave Id_traccia, dimensione (3 x 2) x numTracce
    vector<double> lunghezzaTraccia = {}; /// dimensione 1 x numTracce
    map <unsigned int, vector<Vector2i>> tipoTraccia = {}; /// chiave Id_fratture, dimensione 2 x (2 x numTracce)
